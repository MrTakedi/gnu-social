...
class FavoriteModule extends ActivityVerbHandlerModule
{
    ...
    // FIXME: Set this to abstract public in lib/activityhandlermodule.php ddwhen all plugins have migrated!
    ...
    // FIXME: Put this in lib/activityhandlermodule.php when we're ready
    ...
    /**
     * EndInterpretCommand for FavoriteModule will handle the 'fav' command
