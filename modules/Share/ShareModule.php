...
class ShareModule extends ActivityVerbHandlerModule
{
    ...
    // FIXME: Set this to abstract public in lib/activityhandlermodule.php when all plugins have migrated!
    ...
    /**
     * EndInterpretCommand for RepeatModule will handle the 'repeat' command
