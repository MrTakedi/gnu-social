...
class Profile extends Managed_DataObject
{
     ...
     * @param int            $upto       Maximum unix timestamp
     *
     * @return Profile_list resulting lists
     */

    public function getOtherTags(Profile $scoped = null, $offset = 0, $limit = null, $since = 0, $upto = 0)
    {
        $list = new Profile_list();
    ...
    public function requiresSubscriptionApproval(Profile $other = null)
    {
        if (!$this->isLocal()) {
