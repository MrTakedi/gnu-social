...
class OStatusPlugin extends Plugin
{
    ...
    public function onStartShowSubscriptionsContent($action)
    {
    ...
    public function onEndShowSubscriptionsMiniList($action)
    {
        $this->showEntityRemoteSubscribe($action);
    ...
    public function showEntityRemoteSubscribe($action, $target='ostatussub')
    {
    ...
    public function onStartProfileListItemActionElements($item)
    {
        ...
        $url = common_local_url(
            'ostatusinit',
            ['nickname' => $item->getTarget()->getNickname()]
        );
        $output->element(
            'a',
            [
